<?php
// This adds a Breadcrumb Nav to page
function the_breadcrumb()
{
  ...
  // Home page
  if (is_front_page()) {
    // echo '<li class="item-home"><a class="bread-link bread-home" href="'.get_home_url().'" title="'.$home_title.'">Aktuelles</a></li>';
    echo '<li class="item-home"><p>Aktuelles</p></li>';
  } else {
    // echo '<li class="item-home"><a class="bread-link bread-home" href="'.get_home_url().'" title="'.$home_title.'">'.$home_title.'</a></li>';
    echo '<li class="item-home"><p>'.$home_title.'</p></li>';
  }
  if (!is_front_page()) {
  ...
  if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
    ...
    if ($post->post_parent) {
      ...
      foreach ($anc as $ancestor) {
        ...
        $parents .= '<li class="item-parent item-parent-'.$ancestor.'"><p>'.get_the_title($ancestor).'</p></li>';
